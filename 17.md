...
_Llega la época de navidades y las empresas de transporte están sacando cuentas del número de paquetes van a poder enviar. ¡A ver cómo lo hacemos!_
...
- <code>transportista[0]</code> -> Nombre/ID del Transportista
- <code>transportista[1]</code> -> Paquetes que gestiona en un día
- <code>transportista[2]</code> -> Array con sus subordinados
...
**¡Ten cuidado!** Como has visto en el segundo ejemplo, **el organigrama puede tener diferentes niveles y además nos viene información que puede ser que no necesitemos**. Debemos tener en cuenta el parámetro de <code>carrierID</code> para calcular bien el número y contar todo su equipo.