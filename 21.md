...
_La gente cree que la bolsa de Santa Claus no tiene fondo pero la realidad es que son los elfos que se encargan de hacer que sus viajes encajen para llevar y recoger todos los regalos por todo el mundo._
...
- El viaje que es un array de arrays. Cada subarray contiene tres números que representan:
    - <code>trip[0]</code> = número de regalos a transportar
    - <code>trip[1]</code> = punto de recogida de los regalos
    - <code>trip[2]</code> = punto de entrega de los regalos
